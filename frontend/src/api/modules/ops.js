...
export const deleteAlertIntegration = (id) => request.delete(`/alert-integrations/${id}/`)
...
export const getObservabilitySystemPosture = (params) => request.get('/observability/fire-map/', { params })
export const getSystemPostureSystems = (params) => request.get('/observability/fire-map/systems/', { params })
export const createSystemPostureSystem = (data) => request.post('/observability/fire-map/systems/', data)
export const updateSystemPostureSystem = (id, data) => request.put(`/observability/fire-map/systems/${id}/`, data)
export const deleteSystemPostureSystem = (id) => request.delete(`/observability/fire-map/systems/${id}/`)
...
export const resolveGrafanaToLogs = (data, config = {}) => request.post('/observability/datasource-links/resolve_grafana_to_logs/', data, config)
