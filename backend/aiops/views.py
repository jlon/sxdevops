...
def _incident_action_task_draft(incident, incident_action):
    ...
    draft = {
        **draft,
        ...
        'preconditions': draft.get('preconditions') or incident_action.preconditions or [],
        'verification_plan': draft.get('verification_plan') or draft.get('verification_steps') or incident_action.verification_plan or [],
        'rollback_plan': draft.get('rollback_plan') or draft.get('rollback_steps') or incident_action.rollback_plan or [],
