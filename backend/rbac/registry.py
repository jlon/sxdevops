PERMISSION_DEFINITIONS = [
    ...
    ('ops.observability.firemap.view', '查看灭火图', 'ops', '查看业务级健康灭火图、层级下钻、依赖影响和排障入口'),
    ('ops.observability.firemap.manage', '管理灭火图', 'ops', '新增、编辑、删除业务级灭火图卡片'),
...
BUILTIN_ROLES = [
    ...
    },
    {
        ...
        'permissions': [
            'ops.dashboard.view', 'ops.alert.view', 'ops.log.datasource.view', 'ops.log.query', 'ops.trace.view', 'ops.trace.datasource.view', 'ops.observability.firemap.view', 'ops.observability.link.view', 'ops.grafana.view',
