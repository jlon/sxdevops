PERMISSION_DEFINITIONS = [
    ...
    ('ops.alert.config.view', '查看告警配置', 'ops', '查看告警接入源、通知渠道、接收人、聚合抑制和升级策略'),
    ('ops.alert.config.manage', '管理告警配置', 'ops', '维护告警接入源、通知渠道、接收人、聚合抑制和升级策略'),
    ...
    ('ops.trace.view', '查看链路追踪', 'ops', '查看 SkyWalking 与 OpenTelemetry 兼容链路、调用拓扑与 Span 详情'),
    ('ops.trace.datasource.view', '查看链路数据源', 'ops', '查看 SkyWalking、Tempo、Jaeger、Zipkin 链路数据源'),
    ('ops.trace.datasource.manage', '管理链路数据源', 'ops', '新增、编辑、删除、测试链路追踪数据源'),
    ...
    ('ops.grafana.manage', '管理 Grafana 配置', 'ops', '维护 Grafana URL、默认嵌入路径和看板接入配置'),
    ...
    ('aiops.agent.view', '查看 AIOps Agent', 'aiops', '查看默认和自定义智能体配置'),
    ('aiops.agent.manage', '管理 AIOps Agent', 'aiops', '注册、编辑、启停和删除自定义智能体'),
    ('aiops.agent.run', '使用自定义 AIOps Agent', 'aiops', '在会话中选择非默认智能体'),
    ('aiops.agent.full_execute', 'AIOps Agent 自动执行', 'aiops', '允许智能体在后端策略允许时自动落任务中心并执行'),
    ('aiops.incident.view', '查看 AIOps Incident', 'aiops', '查看告警归并后的故障工作对象、关联告警和状态'),
    ('aiops.incident.manage', '管理 AIOps Incident', 'aiops', '手动维护 Incident 的状态、负责人和影响摘要'),
    ('aiops.incident.investigate', '启动 AIOps Incident 调查', 'aiops', '启动 Incident 的只读取证和根因分析任务'),
    ('aiops.incident.close', '关闭 AIOps Incident', 'aiops', '关闭已恢复或已完成复盘的 Incident'),
...
BUILTIN_ROLES = [
    ...
    },
    {
        ...
        'permissions': [
            ...
            'rbac.audit.view',
            'aiops.agent.view', 'aiops.agent.manage', 'aiops.agent.run',
            'aiops.incident.view', 'aiops.incident.manage', 'aiops.incident.investigate', 'aiops.incident.close',
    ...
    },
    {
        ...
        'permissions': [
            ...
            'aiops.agent.run', 'aiops.incident.view', 'aiops.incident.investigate', 'aiops.chat.view', 'aiops.chat.analyze', 'aiops.task.generate', 'aiops.runbook.view', 'aiops.review.view',
            'cmdb.dashboard.view', 'cmdb.ci.view',
    ...
    },
    {
        ...
        'permissions': [
            'aiops.knowledge.view',
            'eventwall.view', 'eventwall.source.view', 'rbac.audit.view', 'aiops.incident.view', 'aiops.chat.view', 'aiops.chat.analyze', 'aiops.runbook.view', 'aiops.review.view',
    ...
    },
    {
        ...
        'permissions': [
            ...
            'eventwall.view', 'eventwall.source.view', 'aiops.chat.view', 'aiops.knowledge.view', 'aiops.agent.view', 'aiops.incident.view', 'aiops.config.view', 'aiops.mcp.view', 'aiops.runbook.view', 'aiops.review.view',
