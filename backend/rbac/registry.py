PERMISSION_DEFINITIONS = [
    ...
    ('ops.observability.firemap.view', '查看系统态势', 'ops', '查看业务系统健康、SLA 总览、层级下钻与依赖影响'),
    ('ops.observability.firemap.manage', '管理系统态势', 'ops', '新增、编辑、删除系统态势卡片'),
...
BUILTIN_ROLES = [
    ...
    },
    {
        ...
        'permissions': [
            ...
            'ops.observability.firemap.view', 'ops.observability.firemap.manage', 'ops.observability.link.view', 'ops.observability.link.manage', 'ops.grafana.view', 'ops.grafana.manage',
    ...
    },
    {
        ...
        'permissions': [
            ...
            'ops.log.query', 'ops.log.datasource.view', 'ops.trace.view', 'ops.trace.datasource.view', 'ops.observability.firemap.view', 'ops.observability.link.view', 'ops.grafana.view', 'ops.middleware.view',
    ...
    },
    {
        ...
        'permissions': [
            'ops.dashboard.view', 'ops.alert.view', 'ops.alert.config.view', 'ops.log.datasource.view', 'ops.log.query', 'ops.trace.view', 'ops.trace.datasource.view', 'ops.observability.firemap.view', 'ops.observability.link.view', 'ops.grafana.view',
    ...
    },
    {
        ...
        'permissions': [
            'ops.dashboard.view', 'ops.host.view', 'ops.host.schedule.view', 'ops.deployment.view', 'ops.ticket.view', 'ops.alert.view', 'ops.alert.config.view',
            'ops.log.entry.view', 'ops.log.datasource.view', 'ops.log.query', 'ops.trace.view', 'ops.trace.datasource.view', 'ops.observability.firemap.view', 'ops.observability.link.view', 'ops.grafana.view', 'ops.k8s.view', 'ops.docker.view',
